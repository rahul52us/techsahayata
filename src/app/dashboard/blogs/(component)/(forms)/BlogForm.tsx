...
const BlogForm = observer(({ initialValues, submitForm, loading }: any) => {
  ...
  const sendDataToBackend = () => {
    const { title, content, subTitle, websites, tags, coverImage, isPrivate, slug, category } = formState;
    if (!title || !content || !subTitle) {
      toast({
        title: "Validation Error",
        description: "Title, content, and subtitle (excerpt) cannot be empty.",
        status: "error",
        duration: 3000,
        isClosable: true,
      });
    ...
    submitForm({ title, content, excerpt: subTitle, subTitle, websites, tags, coverImage, isPrivate, slug, category });
  };
  ...
  const { isPreviewMode, title, subTitle, content, websites, tags, tagInput } = formState;
          ...
          <Flex justify="space-between" align="center" mb={4} flexWrap="wrap" gap={3}>
            ...
            <Flex gap={3} align="center">
              <CustomInput
                ...
                onChange={(e: any) => handleStateChange("isPrivate", e?.target?.checked)}
              />
              <Button
                size="sm"
          ...
          <TabPanels>
            ...
            <TabPanel>
              <VStack align="stretch" spacing={3}>
                ...
                {/* Websites Input */}
                <Text fontWeight="medium" fontSize="sm" color="gray.700" mt={2}>
                  Publish to Websites
                </Text>
                <CustomInput
                  name="websites"
                ...
                <Flex gap={2}>
                  <Input
                    ...
                    value={tagInput}
                    onChange={(e: any) => handleStateChange("tagInput", e.target.value)}
                    size="md"
                    borderColor="gray.300"
                    focusBorderColor="teal.500"
                    borderRadius="md"
